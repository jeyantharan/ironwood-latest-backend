...
//     enobjout = await createObject(req.body.Name,place.url,req.body.Description,req.body.ShortDescription,req.body.Map,req.body.Type,req.body.DirMap,req.body.Phone);
//     deobjout = await createObject(sout[0],place.url,sout[1],sout[2],req.body.Map,req.body.Type,req.body.DirMap,req.body.Phone);
//     itobjout = await createObject(sout1[0],place.url,sout1[1],sout1[2],req.body.Map,req.body.Type,req.body.DirMap,req.body.Phone);
//     csobjout = await createObject(sout2[0],place.url,sout2[1],sout2[2],req.body.Map,req.body.Type,req.body.DirMap,req.body.Phone);
